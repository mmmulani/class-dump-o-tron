...
@interface XRStreamedPowerDataSource : NSObject <XRBrushDataSource>
{
    struct {
        unsigned int isStateStream:1;
        unsigned int isMeasurementStream:1;
    } _config;
...
- (id)run:(id)arg1 pathTypeForState:(unsigned long long)arg2 graphAtIndex:(long long)arg3;
- (struct XRPathAttribute)run:(id)arg1 attributeForState:(unsigned long long)arg2 graphAtIndex:(long long)arg3;
- (id)run:(id)arg1 colorForPoint:(struct XRGraphPoint *)arg2 graphAtIndex:(long long)arg3;
