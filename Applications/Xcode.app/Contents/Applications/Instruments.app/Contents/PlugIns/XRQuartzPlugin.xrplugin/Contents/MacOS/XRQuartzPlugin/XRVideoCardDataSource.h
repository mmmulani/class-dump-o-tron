...
@interface XRVideoCardDataSource : NSObject <XRBrushDataSource>
{
    NSString *_brushType;
}

+ (id)run:(id)arg1 abbreviationForStatistic:(id)arg2;
- (void)run:(id)arg1 userFocusedOnPoint:(struct XRGraphPoint *)arg2 forInspectionTimeStamp:(unsigned long long)arg3;
- (void)run:(id)arg1 provideLabel:(id *)arg2 andLabelPosition:(struct XRGraphPoint *)arg3 forInspectionTimeStamp:(unsigned long long)arg4 graphAtIndex:(long long)arg5;
