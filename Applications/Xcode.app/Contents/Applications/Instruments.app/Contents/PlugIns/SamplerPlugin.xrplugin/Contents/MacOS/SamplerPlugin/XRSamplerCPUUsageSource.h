...
@interface XRSamplerCPUUsageSource : NSObject <XRBrushDataSource>
{
}

+ (void)enumerateUsagePointsForRun:(id)arg1 timeRange:(struct XRTimeRange)arg2 minimumInterval:(unsigned long long)arg3 filter:(CDUnknownBlockType)arg4 withBlock:(CDUnknownBlockType)arg5;
