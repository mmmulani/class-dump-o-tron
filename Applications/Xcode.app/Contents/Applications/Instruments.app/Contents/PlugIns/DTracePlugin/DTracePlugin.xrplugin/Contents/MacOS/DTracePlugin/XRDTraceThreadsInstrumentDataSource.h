...
@interface XRDTraceThreadsInstrumentDataSource : NSObject <XRBrushDataSource>
{
    NSString *_brushType;
    NSMutableDictionary *_cachedDataPoints;
    long long _runNumberCached;
}

+ (id)colorsForColsolidatedThreadStates;
+ (id)colorForColsolidatedThreadState:(unsigned long long)arg1;
