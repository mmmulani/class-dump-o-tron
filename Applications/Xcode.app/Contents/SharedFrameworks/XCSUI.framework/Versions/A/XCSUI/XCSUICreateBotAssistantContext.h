...
@class DVTSourceControlWorkspaceBlueprint, IDEScheme, IDEWorkspaceTabController, NSArray, NSError, NSMapTable, NSSet, NSString, NSURL, NSWindow, XCSBot, XCSService, XCSUICreateBotAssistantContextWindowController;
