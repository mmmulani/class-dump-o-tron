...
@class DVTBorderedView, DVTColoredSpinner, DVTObservingToken, DVTTableView, NSArray, NSButton, NSMatrix, NSMenu, NSMenuItem, NSPopUpButton, NSScrollView, NSString, NSTextField, XCSUICreateBotAssistantContext;
