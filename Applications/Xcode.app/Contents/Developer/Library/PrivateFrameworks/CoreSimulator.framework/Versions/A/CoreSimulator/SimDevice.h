...
@class NSArray, NSDictionary, NSDistantObject<SimBridge>, NSMachPort, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString, NSUUID, SimDeviceNotificationManager, SimDeviceSet, SimDeviceType, SimRuntime, SimServiceConnectionManager;
