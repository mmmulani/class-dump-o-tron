...
+ (_Bool)setGenerationOptions:(id)arg1 rowID:(long long)arg2 options:(unsigned long long)arg3 error:(id *)arg4;
+ (_Bool)setGenerationStatus:(id)arg1 rowID:(long long)arg2 status:(int)arg3 error:(id *)arg4;
...
+ (_Bool)rowExists:(id)arg1 withStorageID:(long long)arg2 andName:(id)arg3 andClientID:(id)arg4;
+ (_Bool)thinningPrecompute:(id)arg1 kept:(id)arg2;
- (void).cxx_destruct;
- (id)fullPath:(id)arg1;
- (_Bool)isAccessibleByUID:(unsigned int)arg1 error:(id *)arg2;
