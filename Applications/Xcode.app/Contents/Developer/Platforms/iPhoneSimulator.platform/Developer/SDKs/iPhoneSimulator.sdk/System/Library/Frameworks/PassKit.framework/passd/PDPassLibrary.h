...
- (void)removePassesOfType:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)getImageSetForUniqueID:(id)arg1 ofType:(long long)arg2 displayProfile:(id)arg3 handler:(CDUnknownBlockType)arg4;
...
- (void)isRemovingPassesOfType:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;
- (void)countPassesOfType:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;
- (void)hasPassesOfType:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;
...
- (void)getPassesAndCatalogOfPassTypes:(unsigned long long)arg1 limitResults:(_Bool)arg2 withHandler:(CDUnknownBlockType)arg3;
...
- (void)getPassesOfType:(unsigned long long)arg1 handler:(CDUnknownBlockType)arg2;
- (void)getPassesWithHandler:(CDUnknownBlockType)arg1;
- (void)sendCatalogChanged:(id)arg1;
- (void)sendRemovingPassesOfType:(unsigned long long)arg1 didFinishWithSuccess:(_Bool)arg2;
