...
- (id)description;
- (id)init;
- (_Bool)saveLibraryState:(id)arg1;
- (id)loadLibraryState;
- (_Bool)openAtPath:(id)arg1 isReadOnly:(_Bool)arg2 error:(id *)arg3;
- (_Bool)_installFunctions;
- (_Bool)_setupPragmas;
- (_Bool)_setupPragmasNotUpsetAboutWAL_17553237;
...
- (void)setCorruptionHandler:(CDUnknownBlockType)arg1;
