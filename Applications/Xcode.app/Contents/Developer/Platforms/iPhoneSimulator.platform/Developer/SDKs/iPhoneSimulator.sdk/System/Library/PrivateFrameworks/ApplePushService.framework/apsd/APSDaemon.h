...
@interface APSDaemon : NSObject <APSCourierDelegate, APSIDSProxyManagerDelegate>
{
    ...
    _Bool _hasEnabledCouriers;
    _Bool _systemIsShuttingDown;
    NSObject<OS_xpc_object> *_connection;
}

+ (void)setLaunchdLaunchSemaphoreEnabled:(_Bool)arg1;
...
- (void)proxyManager:(id)arg1 canUseProxyChanged:(_Bool)arg2;
...
- (void)updateSafeToSendFilterForce:(_Bool)arg1;
- (_Bool)_systemIsReady;
