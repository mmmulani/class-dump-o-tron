...
- (_Bool)_queue_deleteAuthorizationRecordsForBundleIdentifier:(id)arg1 error:(id *)arg2;
- (_Bool)_queue_deleteAuthorizationRecordsWithSourceIdentifier:(id)arg1 error:(id *)arg2;
...
- (_Bool)deleteAuthorizationRecordsWithSourceIdentifier:(id)arg1 error:(id *)arg2;
