...
+ (id)statisticsForDataType:(id)arg1 options:(unsigned long long)arg2 healthDaemon:(id)arg3 predicate:(id)arg4 startDate:(id)arg5 endDate:(id)arg6 sourceIdentifier:(id)arg7 orderedSources:(id)arg8 extraSources:(id)arg9 shouldStopProcessing:(CDUnknownBlockType)arg10 error:(id *)arg11;
