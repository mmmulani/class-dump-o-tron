...
@property(readonly, retain, nonatomic) NSArray *emailsToRegister;
- (id)description;
@property(copy, nonatomic) NSString *authenticationToken;
- (_Bool)isEqual:(id)arg1;
@property(readonly, retain, nonatomic) NSDictionary *dictionaryRepresentation; // @dynamic dictionaryRepresentation;
...
- (id)_userID;
@property(readonly, retain, nonatomic) NSArray *confirmedEmails;
