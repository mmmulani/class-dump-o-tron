...
+ (_Bool)_isHealthAllowedWithError:(id *)arg1;
...
- (void)startAnchoredObjectQuery:(id)arg1 sampleType:(id)arg2 filter:(id)arg3 anchor:(id)arg4 limit:(unsigned long long)arg5 client:(id)arg6 handler:(CDUnknownBlockType)arg7;
- (void)startStatisticsCollectionQuery:(id)arg1 sampleType:(id)arg2 filter:(id)arg3 anchorDate:(id)arg4 statisticsOptions:(unsigned long long)arg5 intervalComponents:(id)arg6 shouldListenForUpdates:(_Bool)arg7 client:(id)arg8 handler:(CDUnknownBlockType)arg9;
- (void)startStatisticsQuery:(id)arg1 sampleType:(id)arg2 filter:(id)arg3 statisticsOptions:(unsigned long long)arg4 client:(id)arg5 handler:(CDUnknownBlockType)arg6;
- (void)startSourcesQuery:(id)arg1 sampleType:(id)arg2 filter:(id)arg3 client:(id)arg4 handler:(CDUnknownBlockType)arg5;
- (void)startSampleQuery:(id)arg1 sampleType:(id)arg2 filter:(id)arg3 maxResults:(unsigned long long)arg4 sortDescriptors:(id)arg5 client:(id)arg6 handler:(CDUnknownBlockType)arg7;
