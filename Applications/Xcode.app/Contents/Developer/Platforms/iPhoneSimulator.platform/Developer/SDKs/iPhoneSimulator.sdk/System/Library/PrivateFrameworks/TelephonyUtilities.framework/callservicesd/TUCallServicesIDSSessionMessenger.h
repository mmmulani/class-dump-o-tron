...
- (void)sendMessageAndStartSessionIfNecessary:(id)arg1 withDevice:(id)arg2 timeout:(long long)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)_runBlocksPendingSocketAvailability:(_Bool)arg1;
@property(readonly, nonatomic) int availableSocket;
- (void)pendMessageOnSessionConnection:(id)arg1;
- (void)_sendMessagesPendingSessionAvailability:(_Bool)arg1;
- (void)dealloc;
