...
+ (_Bool)systemSupportsService:(id)arg1 type:(int)arg2;
+ (_Bool)systemSupportsRegistrationInfo:(id)arg1;
+ (_Bool)_systemSupportsServiceType:(id)arg1 type:(int)arg2;
+ (id)sharedInstance;
+ (_Bool)validSIMStateForRegistration;
+ (void)initialize;
@property(readonly, retain, nonatomic) NSArray *activeRegistrations; // @synthesize activeRegistrations=_activeRegistrations;
@property(readonly, retain, nonatomic) NSArray *authenticatedRegistrations; // @synthesize authenticatedRegistrations=_authenticatedRegistrations;
@property(readonly, retain, nonatomic) NSArray *trackedRegistrations; // @synthesize trackedRegistrations=_trackedRegistrations;
- (void)systemDidLeaveFirstDataProtectionLock;
- (void)_systemConfigurationPrefsChanged;
@property(readonly, retain, nonatomic) NSArray *activeRegistrationsToRegister;
