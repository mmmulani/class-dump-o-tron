...
- (void)queueConnectionToTrustedServiceManagerWithCompletion:(void (^)(_Bool, NSError *))arg1;
- (void)setNewAuthRandomIfNecessary:(void (^)(_Bool))arg1;
- (_Bool)hasDevelopmentSignedSE;
@end
