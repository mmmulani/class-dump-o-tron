...
#import "TRDeviceSetupBrowserDelegate.h"
#import "TRDeviceSetupPeripheralDelegate.h"

@class NSMutableSet, NSObject<OS_dispatch_source>, NSString, TRDeviceSetupBrowser;
