...
- (void)_queue_startNotYetUbiquitousWithPassbookSyncEnabled:(_Bool)arg1 destinationURL:(id)arg2;
- (void)_queue_startAlreadyUbiquitousWithPassbookSyncEnabled:(_Bool)arg1;
