...
- (_Bool)_persistDataAndNotify:(id)arg1 provenance:(unsigned long long)arg2 sourceEntity:(id)arg3 error:(id *)arg4;
- (void)_registerForDeviceNameChanges;
- (_Bool)persistAndNotifyDataObject:(id)arg1 withProvenance:(unsigned long long)arg2 error:(id *)arg3;
- (void)registerForLaunchNotification:(const char *)arg1;
- (void)unregisterForLaunchNotification:(const char *)arg1;
- (void)_didEnableCollection:(_Bool)arg1 forDataType:(id)arg2;
...
- (_Bool)healthDataReceived:(id)arg1 provenance:(unsigned long long)arg2 sourceEntity:(id)arg3 error:(id *)arg4;
