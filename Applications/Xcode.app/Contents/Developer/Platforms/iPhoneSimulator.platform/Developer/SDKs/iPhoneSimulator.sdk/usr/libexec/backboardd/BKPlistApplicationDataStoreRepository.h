...
#import "BKApplicationDataStoreRepository.h"
...
@interface BKPlistApplicationDataStoreRepository : NSObject <BKApplicationDataStoreRepository>
{
    ...
    id <BKApplicationDataStoreRepositoryDelegate> _delegate;
    NSObject<OS_dispatch_queue> *_stateQueue;
    NSObject<OS_dispatch_queue> *_writeQueue;
}

@property(nonatomic) id <BKApplicationDataStoreRepositoryDelegate> delegate; // @synthesize delegate=_delegate;
