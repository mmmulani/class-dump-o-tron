...
#import "SLTwitterAccountCreationDelegate.h"
#import "SLTwitterContactUpdaterDelegate.h"

@class ACAccount, ACAccountType, NSArray, NSMutableDictionary, NSString, PSSetupController, PSSpecifier, SLNetworkReachabilityWarning, SLTwitterContactUpdater, SLTwitterUpdateContactsFooterView, UIAlertView;
...
- (_Bool)_isTwitterParentalRestrictionEnabled;
