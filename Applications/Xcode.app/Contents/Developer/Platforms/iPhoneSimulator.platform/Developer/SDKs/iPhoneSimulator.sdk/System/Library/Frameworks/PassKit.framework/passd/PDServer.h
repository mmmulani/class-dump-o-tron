...
- (void)_handleInAppPaymentInterfaceAlertActivated:(_Bool)arg1;
- (void)_handleContactlessPaymentInterfaceAlertDeactivated:(_Bool)arg1;
- (void)_handleContactlessPaymentInterfaceAlertActivated:(_Bool)arg1;
- (void)_launchContactlessPaymentInterface;
- (void)_clearDefaultPaymentPassIfNeeded;
- (void)_updateDefaultPaymentPassIfNeeded;
- (_Bool)_paymentPassesAvailableToPay;
- (_Bool)_paymentPassesAvailable;
...
- (void)secureElement:(id)arg1 removingPaymentApplicationsDidFinishWithSuccess:(_Bool)arg2;
...
- (_Bool)contactlessInterfaceShouldStartFieldDetection;
...
- (void)notePassWithUniqueID:(id)arg1 isRevoked:(_Bool)arg2;
