...
@property(nonatomic) __weak id <FluidProgressViewDelegate> delegate; // @synthesize delegate=_delegate;
...
- (void)setProgressAnimationSuppressed:(_Bool)arg1 duringFluidProgressState:(id)arg2;
- (void)layoutSubviews;
- (id)init;
