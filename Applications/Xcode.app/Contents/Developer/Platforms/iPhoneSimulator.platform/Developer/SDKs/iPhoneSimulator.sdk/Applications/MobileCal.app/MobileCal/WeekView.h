...
#import "WeekAllDayViewDelegate.h"

@class CalendarOccurrencesCollection, EKDayViewContent, NSCalendar, NSDate, NSDateComponents, NSString, NSTimeZone, UIImage, UIImageView, UIScrollView, WeekAllDayView;
