...
@class GEOComposedRouteStep, MKMapSnapshot, MKMapSnapshotter, MNRoute, NSString, UIColor, UIImage;
...
- (void)_drawRouteLineInRect:(struct CGRect)arg1 zoomLevel:(double)arg2;
