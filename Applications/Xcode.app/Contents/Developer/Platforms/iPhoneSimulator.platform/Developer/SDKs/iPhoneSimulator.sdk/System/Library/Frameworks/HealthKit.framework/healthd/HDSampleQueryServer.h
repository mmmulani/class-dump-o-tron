...
- (void).cxx_destruct;
- (void)_queue_start;
- (id)initWithQueryUUID:(id)arg1 sampleType:(id)arg2 filter:(id)arg3 maxResults:(unsigned long long)arg4 sortDescriptors:(id)arg5 clientProxy:(id)arg6 delegate:(id)arg7 daemon:(id)arg8;
