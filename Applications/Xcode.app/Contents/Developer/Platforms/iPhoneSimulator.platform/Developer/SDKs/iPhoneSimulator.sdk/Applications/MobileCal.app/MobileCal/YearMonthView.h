...
@class EKCalendarDate, EKUIOverlayCalendarSignificantDatesProvider, NSCalendar, NSSet, NSString, UIFont;
...
@property(readonly, nonatomic) double animationMonthDayGridWidthAdjustment;
