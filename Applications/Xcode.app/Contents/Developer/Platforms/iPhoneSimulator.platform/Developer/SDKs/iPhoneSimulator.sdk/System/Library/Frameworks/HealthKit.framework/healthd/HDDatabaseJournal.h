...
- (void).cxx_destruct;
- (void)_resetBuffer;
- (_Bool)_processVersion3JournalWithFileHandle:(id)arg1 fullPath:(id)arg2 daemon:(id)arg3 database:(id)arg4;
- (_Bool)_processJournalFile:(id)arg1 daemon:(id)arg2 sqlDatabase:(id)arg3;
- (_Bool)_mergeJournalData:(id)arg1 daemon:(id)arg2;
