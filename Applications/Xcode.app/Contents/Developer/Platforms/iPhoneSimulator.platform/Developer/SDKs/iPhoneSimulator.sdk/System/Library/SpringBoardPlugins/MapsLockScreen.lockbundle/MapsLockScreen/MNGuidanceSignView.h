...
@class MNGuidanceManeuverView, MNGuidanceSignBackgroundView, MNGuidanceSignDistanceLabel, MNGuidanceSignInstructionsLabel, NSArray, NSString, UIActivityIndicatorView, UIImage, UIImageView, UIView;
