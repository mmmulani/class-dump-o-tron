...
@class FTMessageDelivery, IDSInvitationPushHandler, NSMutableDictionary;
...
+ (id)sharedInstance;
@property(readonly, retain, nonatomic) IDSInvitationPushHandler *invPushHandler; // @synthesize invPushHandler=_invPushHandler;
@property(readonly, retain) NSMutableDictionary *conferenceMaps; // @synthesize conferenceMaps=_conferenceMaps;
@property(readonly, retain) FTMessageDelivery *messageDelivery; // @synthesize messageDelivery=_messageDelivery;
...
- (_Bool)anyPeersForConferenceIDMayRequireBreakBeforeMake:(id)arg1 conferenceID:(id)arg2;
...
- (_Bool)hasPeersForPeerID:(id)arg1 peerID:(id)arg2 conferenceID:(id)arg3;
