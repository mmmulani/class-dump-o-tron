...
@class AXAssertion, AXTimer, UIAttachmentBehavior, UICollisionBehavior, UIDynamicAnimator, UIDynamicItemBehavior, UIGravityBehavior, UIPanGestureRecognizer, UISnapBehavior, UIView;
...
@property(retain, nonatomic) AXTimer *fadeTimer; // @synthesize fadeTimer=_fadeTimer;
