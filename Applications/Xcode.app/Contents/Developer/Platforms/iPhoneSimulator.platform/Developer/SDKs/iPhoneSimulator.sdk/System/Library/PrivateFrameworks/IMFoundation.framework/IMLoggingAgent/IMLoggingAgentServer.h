...
@interface IMLoggingAgentServer : NSObject <IMUserNotificationListener>
{
    ...
    _Bool _pendingInactivityTimer;
    _Bool _automationRunning;
}
...
- (void)endSession:(id)arg1 fromSender:(id)arg2 endNow:(_Bool)arg3;
- (void)_reallyEndSession:(id)arg1;
- (void)pulseForSession:(id)arg1 forSender:(id)arg2;
- (id)_sessionForSessionType:(id)arg1 allowCreation:(_Bool)arg2;
- (void)terminate;
- (void)stop;
- (void)start;
