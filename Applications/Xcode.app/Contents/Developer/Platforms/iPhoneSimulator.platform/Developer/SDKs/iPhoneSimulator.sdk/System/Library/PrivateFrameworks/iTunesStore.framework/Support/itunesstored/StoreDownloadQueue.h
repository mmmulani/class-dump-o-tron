...
@class ISOperationQueue, LoadDownloadQueueOperation, NSMutableOrderedSet, NSMutableSet, NSNumber, NSObject<OS_dispatch_queue>, NSSet, PerformStaleAutoUpdatesOperation;
...
@interface StoreDownloadQueue : NSObject
{
    ...
    _Bool _restoreItemsUnavailableScheduled;
