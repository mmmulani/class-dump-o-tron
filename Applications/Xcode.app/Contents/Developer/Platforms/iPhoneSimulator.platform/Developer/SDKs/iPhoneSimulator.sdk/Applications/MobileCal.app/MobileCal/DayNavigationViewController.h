...
#import "DayNavigationViewDelegate.h"

@class CalendarModel, DayNavigationView, DayNavigationWeekScrollView, DayTwoPartLabel, NSObject<DayNavigationViewCellFactory>, NSObject<DayNavigationViewControllerDelegate>, NSString, UILabel;
