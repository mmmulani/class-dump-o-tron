...
@interface IMLoggingAgentFaceTimeSession : NSObject
{
    ...
    _Bool _initiator;
    _Bool _active;
    _Bool _logCheckpoints;
    _Bool _logDescriptions;
    unsigned int _endFlags;
}

+ (void)_writeStrings:(id)arg1 toPath:(id)arg2;
+ (id)logStringForDate:(id)arg1;
+ (id)logPathForDate:(id)arg1 withBasePath:(id)arg2 isInitiator:(_Bool)arg3;
+ (id)_timeZoneAbbreviation;
@property(nonatomic) unsigned int endFlags; // @synthesize endFlags=_endFlags;
@property _Bool logDescriptionsToConsole; // @synthesize logDescriptionsToConsole=_logDescriptions;
@property _Bool logCheckpointsToConsole; // @synthesize logCheckpointsToConsole=_logCheckpoints;
...
@property _Bool isInitiator; // @synthesize isInitiator=_initiator;
@property(readonly) _Bool isActive; // @synthesize isActive=_active;
...
- (void)startPing:(_Bool)arg1;
- (void)writeSessionLog:(_Bool)arg1;
