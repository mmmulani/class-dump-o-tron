...
@class BirthdayCalendarManager, LocalAttachmentCleanUpSupport, NSArray, NSLock, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_xpc_object>, NSString, NSXPCListener;
