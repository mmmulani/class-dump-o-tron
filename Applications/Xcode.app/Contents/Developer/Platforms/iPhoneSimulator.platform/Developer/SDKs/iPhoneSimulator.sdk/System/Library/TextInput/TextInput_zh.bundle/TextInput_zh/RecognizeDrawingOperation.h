...
@class NSArray, NSString, TIHandwritingStrokes, TIInputManagerHandwriting;
...
+ (id)recognitionResultsForStrokes:(id)arg1 withRecognitionType:(int)arg2 history:(id)arg3 shouldCancel:(CDUnknownBlockType)arg4;
