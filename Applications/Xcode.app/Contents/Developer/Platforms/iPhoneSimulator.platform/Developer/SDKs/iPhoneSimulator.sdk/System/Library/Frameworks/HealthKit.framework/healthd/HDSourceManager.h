...
- (id)_fetchSourceForIdentifier:(id)arg1 name:(id)arg2 createIfNecessary:(_Bool)arg3 createSourceBlock:(CDUnknownBlockType)arg4 error:(id *)arg5;
- (id)_sourceForIdentifier:(id)arg1 name:(id)arg2 createIfNecessary:(_Bool)arg3 overrideName:(_Bool)arg4 createSourceBlock:(CDUnknownBlockType)arg5 error:(id *)arg6;
