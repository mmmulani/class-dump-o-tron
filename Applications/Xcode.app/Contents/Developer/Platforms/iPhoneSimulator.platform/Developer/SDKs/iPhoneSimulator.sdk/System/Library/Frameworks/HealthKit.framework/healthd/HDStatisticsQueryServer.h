...
- (void)_queue_start;
- (id)_quantityType;
- (id)initWithQueryUUID:(id)arg1 sampleType:(id)arg2 filter:(id)arg3 statisticsOptions:(unsigned long long)arg4 clientProxy:(id)arg5 delegate:(id)arg6 daemon:(id)arg7;
